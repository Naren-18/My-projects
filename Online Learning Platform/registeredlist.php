                  ...
                  // {
                    ...
                    if ($result->num_rows > 0) 
                    {
                          ...
                          ?>
                            ...
                            if($row['fee']=="0")
                            {
                              echo "<strong class='com3'>Fresher</strong>";
                            }
                            else
                            {
                              if($row['grade']!="0"){
                                echo "<strong class='com1'>Completed</strong>";
                              }
                              else{
                                echo "<strong class='com2'>Ongoing</strong>";
                              }
                            }
                        ...
                        if (!$con){
                          ...
                          if(isset($_POST['delete']))
                          {
                            ...
                            $sql="DELETE  FROM `registerlist` WHERE uniqueid='$uniqueid'";
