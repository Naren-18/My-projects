...
<body>
<a href="test.php">Hello Click This</a>
  <div class="header">
...
if(isset($_POST['mail'])){
    ...
    if($mail->send()){
        ...
        echo "<h3 class='alert1' >Email Sent </h3>";
        $sqll="DELETE FROM `contactform` WHERE id='$id'";
        if (mysqli_query($con, $sqll)) {
            // header("Refresh:0");
            echo "Its Fucking working";
            // echo "<script>window.open('contactlist.php');</script>";
